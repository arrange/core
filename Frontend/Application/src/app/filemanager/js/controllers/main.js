(function(window, angular, $) {
    ...
    function($scope, $translate, $cookies, fileManagerConfig, Item, FileNavigator, FileUploader) {
        ...
        $scope.smartClick = function(item) {
            ...
            if (item.isEditable()) {
                item.getContent().then(function(data){
                    item.model.currentPathMain = $scope.fileNavigator.currentPath.join('\\');
                    item.model.currentPathMain += "\\"+item.model.name;
                    $scope.$parent.fileSelected(item.model);
                });
                //$scope.touch(item);
